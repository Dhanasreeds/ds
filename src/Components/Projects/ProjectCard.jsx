...
const ProjectCard = ({ img,title, main,videoFile, repoUrl }) => {
  return (
    <div className="p-3 md:p-3 flex-wrap items-center justify-around w-80 bg-[#0c0e19] shadow-xl shadow-slate-900 rounded-2xl">
      <img className="p-4" src={img} alt={`${title} banner`} />
